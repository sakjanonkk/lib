        ...
        <div className="max-w-[100%] w-full h-full mx-auto p-2 flex flex-row justify-center items-center ">
          <div className="mt-36 flex flex-col sm:flex-row">
            <div className="m-2 flex justify-center items-center flex-col">
              ...
              <Link href="/#book">
                <button className="btn-grad hover:bg-right bg-[#B30000] text-white mt-3 py-4 px-7 rounded-50 uppercase cursor-pointer hover:scale-105 ease-in duration-300 text-sm tracking-widest font-semibold">
                  BOOKING HERE
                </button>
              </Link>
            </div>
