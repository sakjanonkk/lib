  ...
  return (
    <div className='w-full lg:h-screen dark:bg-[#282a36]'>
      <div id='book' className='max-w-[90%] m-auto px-2 py-40 w-full'>
        ...
        <h2 className=' tracking-wide py-4 text-center dark:text-[white]'> Booking Page</h2>
                ...
                <div className='px-3 py-2'>
                  <div className='text-lg uppercase'>
                    <div className='flex flex-col'>
                      <label className='uppercase text-sm py-2 dark:text-[white]'>Ex Room Name</label>
                      <input
                  ...
                  <div className='text-lg uppercase dark:text-[white]'>
                    <div className='flex flex-col'>
                      <label className='uppercase text-sm py-2'>Ex Type of room here</label>
                      <input
                        className='border-2 rounded-lg flex py-0 px-2 border-gray-300 dark:bg-[#989898]'
                        type='text'
                      />
                  ...
                  <div className='text-lg uppercase dark:text-[white]'>
                    <div className='flex flex-col'>
                      <label className='uppercase text-sm py-2'>Ex number of room here</label>
                      <input
                        className='border-2 rounded-lg flex py-0 px-2 border-gray-300 dark:bg-[#989898]'
                        type='text'
                      />
                  ...
                  <div className='text-lg uppercase dark:text-[white]'>
                    <div className='flex flex-col'>
                      <label className='uppercase text-sm py-2'>EX Time here</label>
                      <div className='grid md:grid-cols-2'>
                        <input
                          className='border-2 rounded-lg flex border-gray-300 dark:bg-[#989898] mt-2 mx-2'
                          type='text'
                        />
                        <input
                          className='border-2 rounded-lg flex border-gray-300 dark:bg-[#989898] mt-2 mx-2'
            ...
            <div>
              <div>
                <div className='lg:p-4 h-full'>
                  <Image src='/assets/libranameroomV2.png' width={2212} height={1215} alt='/'></Image>
                </div>
              </div>
            </div>
          </div>
